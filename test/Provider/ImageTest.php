...
final class ImageTest extends TestCase
{
    public function testImageUrlUses640x680AsTheDefaultSize(): void
    {
        self::assertMatchesRegularExpression(
            '#^https://placehold.co/640x480/[A-Fa-f0-9]{6}/FFF/png\\?text=\\w+#',
            Image::imageUrl(),
        );
    }
    ...
    {
        self::assertMatchesRegularExpression(
            '#^https://placehold.co/800x400/[A-Fa-f0-9]{6}/FFF/png\\?text=\\w+#',
    ...
    {
        self::assertMatchesRegularExpression(
            '#^https://placehold.co/800x400/[A-Fa-f0-9]{6}/FFF/png\\?text=nature\\+\\w+#',
    ...
    {
        self::assertMatchesRegularExpression(
            '#^https://placehold.co/800x400/[A-Fa-f0-9]{6}/FFF/png\\?text=nature\\+Faker#',
    ...
    public function testImageUrlReturnsLinkToRegularImageWhenGrayIsTrue(): void
    {
        ...
        self::assertMatchesRegularExpression(
            '#^https://placehold.co/800x400/CCCCCC/FFF/png\\?text=nature\\+Faker#',
            $imageUrl,
        );
    }
    ...
    public function testImageUrlAcceptsDifferentImageFormats(): void
    {
        foreach (Image::getFormats() as $format) {
            ...
            self::assertMatchesRegularExpression(
                "#^https://placehold.co/800x400/CCCCCC/FFF/{$format}\\?text=nature\\+Faker#",
                $imageUrl,
            );
        }
    }
