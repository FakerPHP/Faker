...
class Company extends \Faker\Provider\Company
{
    ...
    protected static $companyNameSuffixes = [
        ...
        '-Н', 'Трест', 'Банк', 'Опт', 'Проф', 'Сбыт', 'Центр',
    ];
    /**
    ...
    protected static $companyElements = [
        ...
        'Телеком', 'Инфо', 'Сервис', 'Софт', 'АйТи', 'Рыб', 'Глав', 'Вектор', 'Рем', 'Гор', 'Газ', 'Монтаж', 'Мор',
        'Реч', 'Флот', 'Сиб', 'Каз', 'Инж', 'Вод', 'Пив', 'Хмель', 'Мяс', 'Томск', 'Омск', 'Север', 'Лен',
    ];
