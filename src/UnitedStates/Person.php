...
final class Person implements PersonExtension, GeneratorAwareExtension
{
    ...
    private array $maleNameFormats = [
        ...
        '{{Faker\UnitedStates\Person->firstNameMale}} {{Faker\UnitedStates\Person->lastName}}',
        '{{Faker\UnitedStates\Person->firstNameMale}} {{Faker\UnitedStates\Person->lastName}}',
        '{{Faker\UnitedStates\Person->titleMale}} {{Faker\UnitedStates\Person->firstNameMale}} {{Faker\UnitedStates\Person->lastName}}',
        '{{Faker\UnitedStates\Person->firstNameMale}} {{Faker\UnitedStates\Person->lastName}} {{Faker\UnitedStates\Person->suffix}}',
    ...
    private array $femaleNameFormats = [
        ...
        '{{Faker\UnitedStates\Person->firstNameFemale}} {{Faker\UnitedStates\Person->lastName}}',
        '{{Faker\UnitedStates\Person->firstNameFemale}} {{Faker\UnitedStates\Person->lastName}}',
        '{{Faker\UnitedStates\Person->titleFemale}} {{Faker\UnitedStates\Person->firstNameFemale}} {{Faker\UnitedStates\Person->lastName}}',
        '{{Faker\UnitedStates\Person->firstNameFemale}} {{Faker\UnitedStates\Person->lastName}} {{Faker\UnitedStates\Person->suffix}}',
    ...
    {
        $format = Helper::randomElement($this->titles);
    ...
    {
        $area = Helper::randomNumberBetween(0, 1) === 1 ? Helper::randomNumberBetween(1, 665) : Helper::randomNumberBetween(667, 899);
        $group = Helper::randomNumberBetween(1, 99);
        $serial = Helper::randomNumberBetween(1, 9999);
