...
class Person extends \Faker\Provider\Person
{
    ...
    {
        $randomBirthDateTimestamp = random_int(strtotime('1950-Jan-10'), strtotime('2005-Dec-25'));
        ...
        $birthRegistrationSequence = random_int(1, 500);
        ...
        $randomCheckDigit = random_int(1, 9);
