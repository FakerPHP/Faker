...
class Person extends \Faker\Provider\Person
{
    ...
    protected static $lastName = [
        ...
        'ابتکار', 'ابریشمی', 'ابطحی', 'ابوذر', 'ادب', 'ادیانی', 'ارسباران', 'استادی', 'اشتری', 'اشراقی', 'اشکوری', 'اصفهانی', 'اصلانی', 'اعتبار', 'اعتماد', 'اعلم', 'افخم', 'افخمی', 'اقلیما', 'اللهیاری', 'الهام', 'امانت', 'امانی', 'امیری', 'امین‌زاده', 'امینی', 'انتظامی', 'انوار', 'انوری', 'انوشه', 'اوستا', 'ایمانی',
