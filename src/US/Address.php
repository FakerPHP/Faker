...
final class Address implements AddressExtension, GeneratorAwareExtension
{
    ...
    private array $addressFormats = [
        '{{Faker\English\US\Address->streetAddress}}\n{{Faker\English\US\Address->city}}, {{Faker\English\US\Address->stateAbbreviation}} {{Faker\English\US\Address->postcode}}',
    ];
    ...
    private array $streetAddressFormats = [
        '{{Faker\English\US\Address->buildingNumber}} {{Faker\English\US\Address->streetName}}',
        '{{Faker\English\US\Address->buildingNumber}} {{Faker\English\US\Address->streetName}} {{Faker\English\US\Address->secondaryAddress}}',
    ];

    /** @var string[] */
    private array $streetNameFormats = [
        '{{Faker\English\US\Person->firstName}} {{Faker\English\US\Address->streetSuffix}}',
        '{{Faker\English\US\Person->lastName}} {{Faker\English\US\Address->streetSuffix}}',
    ];
    ...
    private array $cityFormats = [
        '{{Faker\English\US\Address->cityPrefix}} {{Faker\English\US\Person->firstName}}{{Faker\English\US\Address->citySuffix}}',
        '{{Faker\English\US\Address->cityPrefix}} {{Faker\English\US\Person->firstName}}',
        '{{Faker\English\US\Person->firstName}}{{Faker\English\US\Address->citySuffix}}',
        '{{Faker\English\US\Person->lastName}}{{Faker\English\US\Address->citySuffix}}',
    ];
    ...
    /** @var string[] */
    private array $stateAbbreviation = [
    ...
    {
        return Helper::bothify($this->postcodeFormats[array_rand($this->postcodeFormats)]);
    }

    public function streetSuffix(): string
    {
        return Helper::bothify($this->streetSuffix[array_rand($this->streetSuffix)]);
    }
    ...
    {
        return Helper::randomElement($this->stateAbbreviation);
    }

    public function secondaryAddress(): string
    {
        return Helper::bothify($this->secondaryAddressFormats[array_rand($this->secondaryAddressFormats)]);
    }
}
