...
final class Person implements PersonExtension, GeneratorAwareExtension
{
    ...
    private array $maleNameFormats = [
        '{{Faker\English\US\Person->firstNameMale}} {{Faker\English\US\Person->lastName}}',
        '{{Faker\English\US\Person->firstNameMale}} {{Faker\English\US\Person->lastName}}',
        '{{Faker\English\US\Person->firstNameMale}} {{Faker\English\US\Person->lastName}}',
        '{{Faker\English\US\Person->firstNameMale}} {{Faker\English\US\Person->lastName}}',
        '{{Faker\English\US\Person->titleMale}} {{Faker\English\US\Person->firstNameMale}} {{Faker\English\US\Person->lastName}}',
        '{{Faker\English\US\Person->firstNameMale}} {{Faker\English\US\Person->lastName}} {{Faker\English\US\Person->suffix}}',
        '{{Faker\English\US\Person->titleMale}} {{Faker\English\US\Person->firstNameMale}} {{Faker\English\US\Person->lastName}} {{Faker\English\US\Person->suffix}}',
    ];

    /** @var string[] */
    private array $femaleNameFormats = [
        '{{Faker\English\US\Person->firstNameFemale}} {{Faker\English\US\Person->lastName}}',
        '{{Faker\English\US\Person->firstNameFemale}} {{Faker\English\US\Person->lastName}}',
        '{{Faker\English\US\Person->firstNameFemale}} {{Faker\English\US\Person->lastName}}',
        '{{Faker\English\US\Person->firstNameFemale}} {{Faker\English\US\Person->lastName}}',
        '{{Faker\English\US\Person->titleFemale}} {{Faker\English\US\Person->firstNameFemale}} {{Faker\English\US\Person->lastName}}',
        '{{Faker\English\US\Person->firstNameFemale}} {{Faker\English\US\Person->lastName}} {{Faker\English\US\Person->suffix}}',
        '{{Faker\English\US\Person->titleFemale}} {{Faker\English\US\Person->firstNameFemale}} {{Faker\English\US\Person->lastName}} {{Faker\English\US\Person->suffix}}',
    ];
    ...
    {
        return Helper::randomElement($this->suffix);
    }

    public static function ssn(): string
    {
        $area = Helper::boolean() ? Helper::numberBetween(1, 665) : Helper::numberBetween(667, 899);
        $group = Helper::numberBetween(1, 99);
        $serial = Helper::numberBetween(1, 9999);
